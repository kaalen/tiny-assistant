...
1. Clone this repository `git clone https://github.com/kaalen/tiny-assistant.git`
2. Set your git repo username and email:
    ...
    ```
3. Create a virtual environment and install python dependencies `pip install -r requirements.txt`
4. Make sure you have `ffmpeg` for your OS installed. If you don't have you can download from [ffmpeg.org](https://ffmpeg.org/download.html)
4. Download the LLM models you'll be using. Here's some suggested links to models on Hugging Face:
